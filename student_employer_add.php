<!--Page for adding employer from add student page-->
<?php
    $title = "IDCP - Add Employer";
    $page = 'student';
    $page_name = 'add_stu_emp';
...
// 		$emp_id = trim($emp_id);
		...
		$page = 'student_employer_add_success.php';
		header("Location: $page");
    }
     mysqli_close( $dbc ) ;
?>
...
.button {
    ...
    <ol class = "breadcrumb">
        ...
        <li class = "active">Add Employer for Student</li>
    </ol>
        <!-- Page Content -->
        <div id="page-content-wrapper">
            <div class="container" style="padding-right: 100px; max-width: 1100px;">
                <div class="dropdown">
                    ...
                    <form action="student_employer_add.php" method="POST" class="form-horizontal" role="form" data-toggle="validator">
                        ...
                        <div class="form-group">
                            <div class="col-xs-5 col-xs-offset-3">
                                <button type="button" class="btn btn-default" onclick="location.href='add_student.php'">Back</button>
