<!--Allows user to add program for student -->
<?php
...
<ol class = "breadcrumb">
    ...
    <li><a href = "edit_student_program_home.php">Student Program Info</a></li>
    <li class = "active">Add a Program for Student</li>
</ol>
    <!-- Page Content -->
        ...
        <div class="container-fluid">
            <div class="dropdown">
                ...
                <form action="add_edit_student_program.php" method="POST" class="form-horizontal" role="form" data-toggle="validator">
                    ...
                    <div class="form-group">
                        <div class="col-xs-5">
                             <button type="button" class="btn btn-default" onclick ="location.href='edit_student_program_home.php';">Back to Program Info</button>
                        </div>
                    </div>
                </form>
            </div>
